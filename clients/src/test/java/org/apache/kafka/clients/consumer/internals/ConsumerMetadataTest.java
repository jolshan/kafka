...
public class ConsumerMetadataTest {
    ...
    public void testTransientTopics() {
        ...
        metadata.updateWithCurrentRequestVersion(RequestTestUtils.metadataUpdateWith(1, singletonMap("foo", 1), topicIds), false, time.milliseconds());
        ...
        metadata.updateWithCurrentRequestVersion(RequestTestUtils.metadataUpdateWith(1, topicPartitionCounts, topicIds), false, time.milliseconds());
        assertFalse(metadata.updateRequested());
