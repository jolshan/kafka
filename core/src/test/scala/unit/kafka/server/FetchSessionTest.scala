...
class FetchSessionTest {
  ...
  def testFetchRequests(): Unit = {
    ...
    assertEquals(respData2, resp2.responseData(Collections.emptyMap))
    ...
    assertEquals(0, resp5.responseData(Collections.emptyMap).size())
  ...
  def testIncrementalFetchSession(): Unit = {
    ...
    assertEquals(2, resp1.responseData(Collections.emptyMap).size())
    ...
    val resp2 = context2.updateAndGenerateResponseData(respData2)
    assertEquals(Errors.NONE, resp2.error)
    assertEquals(1, resp2.responseData(Collections.emptyMap).size)
  ...
  def testFetchSessionExpiration(): Unit = {
    ...
    assertEquals(2, session1resp.responseData(Collections.emptyMap).size())
    ...
    assertEquals(2, session2resp.responseData(Collections.emptyMap).size())
    ...
    assertEquals(2, session3resp.responseData(Collections.emptyMap).size())
  ...
  def testPrivilegedSessionHandling(): Unit = {
    ...
    assertEquals(2, session4resp.responseData(Collections.emptyMap).size())
  ...
  def testZeroSizeFetchSession(): Unit = {
    ...
    assertTrue(resp2.responseData(Collections.emptyMap).isEmpty)
    assertEquals(0, cache.size)
  }
  ...
  def testDivergingEpoch(): Unit = {
    ...
    assertEquals(Utils.mkSet(tp1, tp2), resp1.responseData(Collections.emptyMap).keySet)
    ...
    assertEquals(Collections.singleton(tp2), resp2.responseData(Collections.emptyMap).keySet)
    ...
    assertEquals(Utils.mkSet(tp1, tp2), resp3.responseData(Collections.emptyMap).keySet)
    ...
    assertEquals(Utils.mkSet(tp1, tp2), resp4.responseData(Collections.emptyMap).keySet)
  }
}
